...
Context genWallets(std::unique_ptr<Monero::WalletManager>& walletManager) {
    Context context;
    context.wallet = std::unique_ptr<Monero::Wallet>(walletManager->createWallet("stagenet1", "123", "en", Monero::NetworkType::STAGENET));
...
Context openWallets(std::unique_ptr<Monero::WalletManager>& walletManager) {
    ...
    context.wallet2->init("127.0.0.1:1984", 0, "", "", false, true); // monero1.exan.tech:18081
    ...
    context.wallet3->init("127.0.0.1:1984", 0, "", "", false, true); //init("monero1.exan.tech:18081");
